      ...
      }:
      {
        imports = lib.singleton (
          lib.stylix.mkTarget
            {
              name = "obs-studio";
              humanName = "OBS Studio";
            }
            {
              config = [
                ({ colors, polarity, ... }: {
                  programs.obs-studio.theme = {
                    obt = ''
                      @OBSThemeMeta {
                        name: 'Stylix';
                    ...
                    ovt = ''
                      ...
                      @OBSThemeVars {
                        --ctp_rosewater: ${colors.withHashtag.base06};
                        --ctp_flamingo: ${colors.withHashtag.base0F};
                        --ctp_pink: ${colors.withHashtag.base0E};
                        --ctp_mauve: ${colors.withHashtag.base0E};
                        --ctp_red: ${colors.withHashtag.base08};
                        --ctp_maroon: ${colors.withHashtag.base08};
                        --ctp_peach: ${colors.withHashtag.base09};
                        --ctp_yellow: ${colors.withHashtag.base0A};
                        --ctp_green: ${colors.withHashtag.base0B};
                        --ctp_teal: ${colors.withHashtag.base0C};
                        --ctp_sky: #89dceb;
                        --ctp_sapphire: #74c7ec;
                        --ctp_blue: ${colors.withHashtag.base0D};
                        --ctp_lavender: ${colors.withHashtag.base07};
                        --ctp_text: ${colors.withHashtag.base05};
                        --ctp_subtext1: ${colors.withHashtag.base04};
                        --ctp_subtext0: ${colors.withHashtag.base04};
                        --ctp_overlay2: ${colors.withHashtag.base03};
                        --ctp_overlay1: ${colors.withHashtag.base03};
                        --ctp_overlay0: ${colors.withHashtag.base02};
                        --ctp_surface2: ${colors.withHashtag.base04};
                        --ctp_surface1: ${colors.withHashtag.base03};
                        --ctp_surface0: ${colors.withHashtag.base02};
                        --ctp_base: ${colors.withHashtag.base00};
                        --ctp_mantle: ${colors.withHashtag.base01};
                        --ctp_crust: ${colors.withHashtag.base02};
                        --ctp_selection_background: ${colors.withHashtag.base04};
                      }
